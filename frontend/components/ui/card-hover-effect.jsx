...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-gradient-to-br from-amber-100 to-white border border-amber-200 dark:border-white/[0.2] group-hover:border-slate-700 relative z-20",
        className
      )}>
